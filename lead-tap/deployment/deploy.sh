#!/bin/bash
# Unified Deployment Script for Stall Capture Backend
# Uses Git clone method - only deploys backend

set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  🚀  Stall Capture — Backend Deployment"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
prompt_input "Enter Git Repository URL (e.g., https://github.com/username/repo.git)" GIT_REPO_URL
...
prompt_input "Enter R2 Bucket Name [$R2_BUCKET_NAME]" R2_BUCKET_NAME_INPUT
R2_BUCKET_NAME=${R2_BUCKET_NAME_INPUT:-$R2_BUCKET_NAME}
...
git clone "$GIT_REPO_URL" "$(basename $PROJECT_DIR)" || error "Git clone failed. Check repository URL and access."

ok "Repository cloned"

# Check if backend directory exists
if [ ! -d "$BACKEND_DIR" ]; then
    error "Backend directory not found in repository. Please check repository structure."
fi
...
# ─── Step 9: Gunicorn Service ───────────────────────────────────────────────
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  🔧  Step 9: Gunicorn Service Setup"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "  Update code: cd $PROJECT_DIR && git pull && sudo systemctl restart gunicorn"
echo ""
